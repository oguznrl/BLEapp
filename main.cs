...
namespace BluetoothLEnergy
{
    public partial class fmMain : Form
    {
        ...
        private void fmMain_Load(object sender, EventArgs e)
        {
            ...
            string[] ports = SerialPort.GetPortNames();  //Baðlý olan seri portlarý diziye ekler
        ...
        private void displayData_event(object sender, EventArgs e)
        {
            if (btSaveCSV.Enabled)
            {
                ...
                File.AppendAllText(@"C:\Users\oguzn\OneDrive\Masaüstü\MyLog.csv", string.Format("\"{0}\", {1} , {2}\n",
                    DateTime.Now.ToString("mm:ss.fff"), SplitedData[0],SplitedData[1]));
            }
            else { 
            SerialScreen.Text += data + "\n"; //Gelen veriyi textBox içine
            } 
        }
